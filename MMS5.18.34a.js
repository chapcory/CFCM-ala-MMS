...
//18.34a
	  ...
	  onPageFlip: function(from, to, orientation) {
        ...
        if ( to == "0Source_MMS")                                           //this is the MMS page name in GUI
        {
      		mms.getStatus();						                        
            mms.log("Autonomic MMS-5 System listening- On Page");
            }
...
//18.3 above		               
			   ...
			   mms.titleRegex.lastIndex = 0;								// Reset the regex to work correctly after each consecutive match
				...
				mms.seconds = Math.floor(mms.remain_seconds);
				mms.time = ("00"+mms.minutes).slice(-2) + ":" + ("00"+mms.seconds).slice(-2);
				CF.setJoin(mms.txtTrackTime, mms.time);
				...
				mms.seconds = Math.floor(mms.remain_seconds);
				mms.time = ("00"+mms.minutes).slice(-2) + ":" + ("00"+mms.seconds).slice(-2);
				CF.setJoin(mms.txtTrackDuration, mms.time);
...
//*/				
                ...
                mms.log("MessageBox3: "+mms.matches[2]);
...
//2 lines				
                ...
                mms.arrayBox = [];     	
                CF.setJoin(mms.subMessageBox, 1);                                       // show the correct subpage	
                mms.log("MessageBox2: "+mms.matches[2]);
...
//1 line				
                ...
                mms.log("MessageBox1: "+mms.matches[2]);
...
// line	0			
                ...
                mms.arrayBox = [];     	
                CF.setJoin(mms.subMessageBox, 1);                                       // show the correct subpage	
                mms.log("MessageBox0: "+mms.matches[2]);
